jQuery(document).ready(function () {
  ...
  if (jQuery(".blog__category__sliders").length > 0) {
    new Waypoint({
      ...
      handler: function (direction) {
        jQuery(".blog__category__sliders").addClass(
          "eff_actived animate__animated animate__zoomIn"
        );
      },
      offset: "70%",
    });
  ...
  if (jQuery(".blog__category").length > 0) {
    new Waypoint({
      ...
      handler: function (direction) {
        jQuery(".blog__category").addClass(
          "eff_actived animate__animated animate__fadeIn"
        );
        jQuery(".blog__category__item").addClass(
          "eff_actived animate__animated animate__zoomIn"
        );
      },
      offset: "60%",
  ...
  if (jQuery(".common__content").length > 0) {
    new Waypoint({
      ...
      handler: function (direction) {
        jQuery(".common__content").addClass(
          "eff_actived animate__animated animate__fadeIn"
        );
      },
      offset: "60%",
  ...
  if (jQuery(".common__sidebar").length > 0) {
    new Waypoint({
      ...
      handler: function (direction) {
        jQuery(".common__sidebar").addClass(
          "eff_actived animate__animated animate__fadeIn"
        );
      },
      offset: "60%",
  ...
  //Carousel for product suggestion
  if (jQuery(".product-suggestion__slider").length > 0) {
    jQuery(".product-suggestion__slider").owlCarousel({
      lazyLoad: true,
      nav: true,
      dots: false,
      //margin: 32,
